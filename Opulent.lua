-- Table that holds our libraries.
-- Format: library variable name = { library require name, library workshop url }
local libraries = {
...
local opulent = {
    ...
    version = "development",
    -- Our table that will convert the obex version names to our desired names.
    version_names = {
        [ "User" ] = "Live",
        [ "Beta" ] = "Beta",
        [ "Debug" ] = "Nightly"
...
-- Format: "new_item( ui.new_whatever_you_want, name in the menu, description, conditions, regular arguments )"
-- Conditions format: "{ { ui item you want as a condition, value for that item }, repeat as needed }"
...
do
    ...
    libraries.http.get( "https://cdn.discordapp.com/attachments/1097129221404491827/1100773720630501448/opulent_1.png", function( success, response )
